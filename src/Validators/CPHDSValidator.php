...
class CPHDSValidator extends ShippingValidatorHandler implements CountryListValidator, StateListValidator
{
    ...
    public const EXCEEDED_COMPANY_NAME_SIZE = 'company.should.have.less.or.equal.than.20.characters';
