...
class SCSTSEXSValidator extends ShippingValidatorHandler implements CountryListValidator, StateListValidator
{
    ...
    protected function validateConsigneeData(): void
    {
        ...
        $this->assert(
            strlen((string) $address->getState()) !== 2,
