...
final class ITCRValidatorTest extends ShippableTestBase
{
    protected $validator = null;

    public function testITCRValidatorHappyPath(): void
    {
        ...
        $shipping = new Shipping([
            'ConsigneeAddress' => $this->getItalyConsigneeAddressFixture(),
    ...
    public function testITCRValidatorBadPath(): void
    {
