...
final class CPHDSValidatorTest extends ShippableTestBase
{
    protected $validator = null;

    public function testCPHDSValidatorHappyPath(): void
    {
        ...
        $shipping = new Shipping([
            ...
            'Length' => '20',
            'Service' => ShippingServices::CPHDS,
    ...
    public function testCPHDSValidatorBadPath(): void
    {
