...
final class PPNHDSDSHValidatorTest extends ShippableTestBase
{
    protected $validator = null;

    public function testPPNDValidatorHappyPath(): void
    {
        ...
        $shipping = new Shipping([
            'ConsigneeAddress' => $this->getNetherlandsConsigneeAddressFixture(),
    ...
    public function testPPNDValidatorBadPath(): void
    {
    ...
    public function testPPNDSValidatorHappyPath(): void
    {
        $products = new ProductsBag([
            'products' => [
                $this->getProductItemFixture(
        ...
        $shipping = new Shipping([
            ...
            'LabelFormat' => LabelFormats::PNG,
            'Length' => '20',
            'Service' => ShippingServices::PPNDS,
            'ShipperReference' => 'Reference_001',
            'Source' => 'NotDeliveryBoy',
            'Value' => '500',
            'Weight' => '10',
    ...
    public function testPPNDSValidatorBadPath(): void
    {
        $this->expectException(ValidatorException::class);
        $this->expectExceptionMessageMatches('/exceeded.weight/');
    ...
    public function testPPHDValidatorHappyPath(): void
    {
        $products = new ProductsBag([
            'products' => [
                $this->getProductItemFixture(
    ...
    public function testPPHDValidatorBadPath(): void
    {
        $this->expectException(ValidatorException::class);
        $this->expectExceptionMessageMatches('/exceeded.weight/');
    ...
    public function testPPHDSValidatorHappyPath(): void
    {
        $products = new ProductsBag([
            'products' => [
                $this->getProductItemFixture(
        ...
        $shipping = new Shipping([
            ...
            'LabelFormat' => LabelFormats::PNG,
            'Length' => '20',
            'Service' => ShippingServices::PPHDS,
            'ShipperReference' => 'Reference_001',
            'Source' => 'NotDeliveryBoy',
            'Value' => '500',
            'Weight' => '10',
    ...
    public function testPPHDSValidatorBadPath(): void
    {
        $this->expectException(ValidatorException::class);
        $this->expectExceptionMessageMatches('/exceeded.weight/');
