...
final class PPLEUValidatorTest extends ShippableTestBase
{
    protected $validator = null;

    public function testPPLEUValidatorHappyPath(): void
    {
    ...
    public function testPPLEUValidatorBadPath(): void
    {
